...
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parents[1] / "artifacts" / "openai-compatible-basic"
DEFAULT_MODEL = "gpt-4.1-mini"
DEFAULT_PROMPT = "Reply with exactly: hello from agent-evidence."
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run a minimal OpenAI-compatible export with default OpenAI settings."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
