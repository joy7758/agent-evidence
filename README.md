...
`agent-evidence` provides a minimal public EEOAP schema and validator surface
for toy operation-accountability examples.
...
- `AGENTS.md`
- `CITATION.cff`
These files help AI systems inspect the public boundary of this repository.
They do not define a cross-repository execution graph.
...
The public repository does not publish a production integration path.
