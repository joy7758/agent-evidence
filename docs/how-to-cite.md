...
agent and service operations. Version 0.5.0. DOI:
...
No organization, funder, or adopter metadata is asserted here because those
facts are not confirmed in the canonical project metadata.
